...
class BagLearner():  		  	   		 	 	 			  		 			     			  	 
    ...
    def query(self, points):  		  	   		 	 	 			  		 			     			  	 
        ...
        predictions = np.append(predictions, np.mean(predictions, axis=0).reshape(1,-1), axis=0) # Compute the mean predictions of all learners and append to last row.
        return predictions[-1,:] 		 # Return mean predictions in the last row   			  	 
